...
public class SecretMessageBox {
	public static void main(String[] args) {
		String E = "9507";
		String message = JOptionPane.showInputDialog(null, "~ENTER SECRET MESSAGE");
		String password = JOptionPane.showInputDialog(null, "~NOW YOU! GUESS THE PASSCODE TO SEE A MESSAGE~");
		...
		if (password.equalsIgnoreCase(E)) {
			...
			JOptionPane.showMessageDialog(null, "No message 4 u! HAHA!");
